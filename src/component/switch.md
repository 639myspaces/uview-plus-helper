...
### [#](http://118.25.198.98/components/switch.html#api) API

### [#](http://118.25.198.98/components/switch.html#switch-props) Switch Props
...
|value|通过v-model双向绑定的值|Boolean|String|Number|
...
### [#](http://118.25.198.98/components/switch.html#switch-event) Switch Event
