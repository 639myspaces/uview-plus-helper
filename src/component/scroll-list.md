...
### [#](http://118.25.198.98/components/scrollList.html#api) API

### [#](http://118.25.198.98/components/scrollList.html#props) Props

|参数|说明|类型|默认值|可选值|
|---|---|---|---|---|
|scroll|是否允许滚动|Boolean|true|false|
...
### [#](http://118.25.198.98/components/scrollList.html#events) Events
