...
### [#](http://118.25.198.98/components/button.html#api) API

### [#](http://118.25.198.98/components/button.html#props) Props
...
|size|按钮的大小|String|normal|large / mini / small|\-|
...
### [#](http://118.25.198.98/components/button.html#events) Events
